...
mods.thaumcraft.Arcane.addShaped("RUNEALTAR", <Botania:runeAltar>, "ordo 20, aer 10, aqua 7, perditio 7",[[<Botania:manaResource>, <Thaumcraft:blockStoneDevice:2>, <Botania:manaResource>],[<Botania:livingrock>, <Thaumcraft:ItemShard:6>, <Botania:livingrock>],[<Botania:livingrock>, <Botania:manaResource:2>, <Botania:livingrock>]]);
mods.thaumcraft.Arcane.addShaped("ALTAR", <Botania:altar>, "ordo 15, terra 12, aqua 9, perditio 10",[[<minecraft:stone_slab:3>, <Botania:petal>, <minecraft:stone_slab:3>],[null, <Thaumcraft:blockCosmeticSolid:6>, null],[<minecraft:cobblestone>, <Thaumcraft:blockCosmeticOpaque>, <minecraft:cobblestone>]]);
...
mods.thaumcraft.Arcane.addShaped("PNR", <Botania:fireRod>, "ignis 20, perditio 10",[[null, null, <Botania:quartz:2>],[null, <Botania:manaResource:3>, null],[<Botania:rune:1>, null, null]]);
mods.thaumcraft.Arcane.addShaped("PNR", <Botania:dirtRod>, "ordo 5, terra 20, perditio 10",[[null, null, <minecraft:dirt>],[null, <Botania:manaResource:3>, null],[<Botania:rune:2>, null, null]]);
...
mods.thaumcraft.Arcane.addShaped("PNR", <Botania:waterRod>, "aqua 25",[[null, null, <minecraft:potion>],[null, <Botania:manaResource:3>, null],[<Botania:rune>, null, null]]);
mods.thaumcraft.Arcane.addShaped("PNR", <Botania:tornadoRod>, "aer 40",[[null, null, <minecraft:feather>],[null, <Botania:manaResource:3>, null],[<Botania:rune:3>, null, null]]);
mods.thaumcraft.Arcane.addShaped("PNR", <Botania:rainbowRod>, "ignis 50, terra 50, aqua 50, perditio 50, aer 50, ordo 50",[[null, <Botania:manaResource:8>, <Botania:manaResource:9>],[null, <Botania:manaResource:7>, <Botania:manaResource:8>],[<Botania:manaResource:7>, null, null]]);
...
mods.thaumcraft.Arcane.addShaped("BTNB", <Botania:superTravelBelt>, "aer 70, perditio 30",[[<Botania:manaResource:7>, <Botania:travelBelt>, <Botania:manaResource:7>],[null, <Botania:manaResource:5>, null],[null, null, null]]);
...
mods.thaumcraft.Arcane.addShaped("BTNB", <Botania:superLavaPendant>, "ignis 60",[[<minecraft:blaze_rod>, <Botania:quartz:2>, <minecraft:blaze_rod>],[<Botania:quartz:2>, <Botania:lavaPendant>, <Botania:quartz:2>],[<Botania:customBrick>, <Botania:manaResource:5>, <Botania:customBrick>]]);
...
mods.thaumcraft.Arcane.addShaped("BTNB", <Botania:flightTiara>, "aer 80",[[<Botania:manaResource:5>, <Botania:manaResource:5>, <Botania:manaResource:5>],[<Botania:manaResource:7>, <Botania:manaResource:5>, <Botania:manaResource:7>],[<minecraft:feather>, <Botania:manaResource:7>, <minecraft:feather>]]);

//The Tab
mods.thaumcraft.Research.addTab("BTN", "botania", "textures/items/dragonstone.png");
game.setLocalization("en_US", "tc.research_category.BTN", "Botania");

//Botania-TC 101
mods.thaumcraft.Research.addResearch("BASICSBTN", "BTN", "herba 100, terra 150, sensus 200", 0, 0, 4, <Botania:lexicon>);
game.setLocalization("en_US", "tc.research_name.BASICSBTN", "Botania-TC 101");
game.setLocalization("en_US", "tc.research_text.BASICSBTN", "[BTN]Changes you need to know.");
...
game.setLocalization("en_US", "tc.research_text.RUNEALTAR", "[BTN]Botania essentials");
mods.thaumcraft.Research.addPage("RUNEALTAR", "derp.research_page.RUNEALTAR");
game.setLocalization("en_US", "derp.research_page.RUNEALTAR", "The Runic Altars main use is to infuse items into living rock in order to make PURE runes");
...
game.setLocalization("en_US", "tc.research_name.ALTAR", "Petal Apothecary");
game.setLocalization("en_US", "tc.research_text.ALTAR", "[BTN]Botania essentials");
mods.thaumcraft.Research.addPage("ALTAR", "derp.research_page.ALTAR");
game.setLocalization("en_US", "derp.research_page.ALTAR", "The Petal Apothecary is used to make magic based plants");
...
game.setLocalization("en_US", "tc.research_name.TAINTR", "New Petal Apothecary Recipes");
game.setLocalization("en_US", "tc.research_text.TAINTR", "Be happy!");
mods.thaumcraft.Research.addPage("TAINTR", "derp.research_page.TAINTR");
game.setLocalization("en_US", "derp.research_page.TAINTR", "Tired of those pesky taint tendrils evaporating and infecting you but need it for still need it for something? Well look no further because this recipe does everything and more!<BR>WARNING:does not do more.");
...
game.setLocalization("en_US", "tc.research_name.EVILRUNES", "Corrupting Runes");
game.setLocalization("en_US", "tc.research_text.EVILRUNES", "Spooky Scary Skeletons!");
mods.thaumcraft.Research.addPage("EVILRUNES", "derp.research_page.EVILRUNES");
game.setLocalization("en_US", "derp.research_page.EVILRUNES", "Corrupted Runes are like runes, but... corrupted... kind of implied I know");
...
game.setLocalization("en_US", "tc.research_name.PNR", "Pylons and Rods");
game.setLocalization("en_US", "tc.research_text.PNR", "Useful Utilities and Magical Floaties!");
mods.thaumcraft.Research.addPage("PNR", "derp.research_page.PNR");
game.setLocalization("en_US", "derp.research_page.PNR", "Thaumcraft may have their staves and wands, but Botania has bad ass forces of nature infused into a stick!<BR>#BotaniaMasterRace");
...
game.setLocalization("en_US", "tc.research_name.BTNB", "Baubles");
game.setLocalization("en_US", "tc.research_text.BTNB", "Trinkets and Doo-dads");
mods.thaumcraft.Research.addPage("BTNB", "derp.research_page.BTNB");
game.setLocalization("en_US", "derp.research_page.BTNB", "Trinkets for your everyday life");
