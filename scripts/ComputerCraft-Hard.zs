...
#recipes.addShaped(<ComputerCraft:CC-Computer>, [[<minecraft:iron_ingot>, <appliedenergistics2:item.ItemMultiMaterial:23>, <minecraft:iron_ingot>], [r, <Forestry:thermionicTubes:5> ,<Forestry:chipsets:3>], [<minecraft:iron_ingot>, <minecraft:glass>, <minecraft:iron_ingot>]]);
