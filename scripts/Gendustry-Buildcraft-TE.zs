...
val diamondChipset = <BuildCraft|Silicon:redstoneChipset>.withTag({type: "Diamond"});
...
val silkWisp = <Forestry:craftingMaterial:2>;
...
recipes.addShaped(upgradeFrameSieve, [[silkWisp, alvearySieve, silkWisp], [alvearySieve, upgradeFrame, alvearySieve], [null, null, null]]);
